...
class FineTunedVGG(nn.Module):
    def __init__(self):
        ...
        self.vgg.classifier[6] = nn.Linear(num_ftrs, 2)  # 修改最后一层分类层
...
if __name__ == '__main__':
    ...
    optimizer = optim.Adam(net.parameters(), lr=0.0001)  # 使用Adam优化器
